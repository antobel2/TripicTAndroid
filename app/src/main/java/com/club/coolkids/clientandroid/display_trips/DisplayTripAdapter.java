...
public class DisplayTripAdapter extends ArrayAdapter<TripDTO> {

    public DisplayTripAdapter(@NonNull Context context) {
        super(context, R.layout.display_trips_list_item);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View v = li.inflate(R.layout.display_trips_list_item, null, false);
        final TripDTO tripDTO = getItem(position);
        TextView tvTrip = v.findViewById(R.id.tvTrip);
